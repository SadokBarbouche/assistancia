...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#03045E", marginTop: "-10px" }}>
        <Fade left>
          <Container className="py-4">
                ...
                >
                  ...
                  <li>
                    <span>
                      ...
                      You can reach us at{" "}
                      <span className="fw-bolder">INSAT</span> or{" "}
                      <span className="fw-bolder">FST</span>
                    </span>
                  </li>
                </ul>
              </Col>
              <Col>
                <Image fluid src={connectFooter} style={{}} className="d-none d-md-block" />
                <div style={{ display: "flex",  }} className="me-md-3 justify-content-center justify-content-md-end">
                  <a
                    target="blank"
                    href="blank"
            ...
            <div className="text-light fw-bolder">
              <p
                className="pt-5 text-decoration-underline"
                style={{ letterSpacing: "3px" }}
              >
                Copyright : @Assistancya 2022
              </p>
            </div>
          </Container>
        </Fade>
